...
def add_gd_download(link, listener, is_gdtot, is_gdflix, is_unified, is_udrive, is_sharer, is_sharedrive, is_filepress, new_name=None):
    ...
    if (is_gdtot or is_unified or is_udrive or is_sharer or is_gdflix):
